...
insert into hotelroom(hotel_id,type_id,name,bed_quantity,price,description,image) values (2,1,'Phòng Hinode Giường Đôi',2,3000000,'View biển, đầy đủ tiện nghi','https://tripi.vn/cdn-cgi/image/width=1280,height=1280/https://storage.googleapis.com/hms_prod/photo/img/2693vG/premium-family--quad-23.jpg');
use hotelbookingdb;
...
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (1,1,1,'2022-05-05','2022-05-10',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (2,2,2,'2022-05-21','2022-05-23',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (3,3,3,'2022-05-25','2022-05-28',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (4,4,4,'2022-05-10','2022-05-15',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (5,5,5,'2022-05-21','2022-05-23',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (6,6,6,'2022-05-25','2022-05-28',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (7,7,7,'2022-05-10','2022-05-15',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (8,8,8,'2022-05-21','2022-05-23',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (9,9,9,'2022-05-25','2022-05-28',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (10,10,10,'2022-05-10','2022-05-15',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (11,11,11,'2022-05-21','2022-05-23',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (12,12,12,'2022-05-25','2022-05-28',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (13,13,13,'2022-05-10','2022-05-15',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (14,14,14,'2022-05-21','2022-05-23',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (15,15,15,'2022-05-25','2022-05-28',0);
insert into booking(room_id,user_id,hotel_id,checkin_date,checkout_date,status) values (16,16,16,'2022-05-10','2022-05-15',0);