...
ALTER TABLE usser ADD CONSTRAINT fk_user_role FOREIGN KEY (roleid) REFERENCES role(id);


ALTER TABLE hotel ADD CONSTRAINT fk_hotel_user FOREIGN KEY (user_id) REFERENCES usser(id);
...
ALTER TABLE booking ADD CONSTRAINT fk_booking_user FOREIGN KEY (user_id) REFERENCES usser(id);
